...
export default function Layout({ children }) {
  ...
  const navButtonSx = () => ({
    ...
    '&.Mui-selected': {
      color: '#1b2333',
      background: '#f1f3ff',
      boxShadow: 'inset 0 0 0 1px #e3e6fb',
    },
  ...
  return (
    <Box className="app-shell" sx={{ display: 'flex' }}>
      <AppBar className="nav" position="fixed" color="default" elevation={0} sx={{ zIndex: (theme) => theme.zIndex.drawer + 1, bgcolor: '#fff', color: 'text.primary', borderBottom: '1px solid', borderColor: 'divider' }}>
        <Toolbar className="nav-inner" sx={{ gap: 2 }}>
      ...
      >
        ...
        <Box sx={{ overflow: 'auto' }}>
          ...
          >
            ...
            <ListItem disablePadding>
              <Tooltip placement="right" title={collapsed ? 'Resumes' : ''} disableHoverListener={!collapsed}>
                <ListItemButton
                  selected={location.pathname.startsWith('/resumes')}
            ...
            <ListItem disablePadding>
              <Tooltip placement="right" title={collapsed ? 'AI Courses' : ''} disableHoverListener={!collapsed}>
                <ListItemButton
                ...
                >
                  ...
                  <ListItemText primary="AI Courses" />
                </ListItemButton>
              </Tooltip>
            </ListItem>
            <ListItem disablePadding>
              <Tooltip placement="right" title={collapsed ? 'Generate' : ''} disableHoverListener={!collapsed}>
                <ListItemButton
                  selected={location.pathname.startsWith('/generate-course')}
                  onClick={handleNav('/generate-course')}
                  sx={navButtonSx}
                >
                  <ListItemIcon><AutoAwesomeIcon /></ListItemIcon>
                  <ListItemText primary="Generate Course" />
                </ListItemButton>
              </Tooltip>
            </ListItem>
            <ListItem disablePadding>
              <Tooltip placement="right" title={collapsed ? 'My Learning' : ''} disableHoverListener={!collapsed}>
                <ListItemButton
                  selected={location.pathname.startsWith('/my-courses')}
      ...
      <Box component="main" className="container" sx={{ flexGrow: 1, p: 3, bgcolor: 'transparent' }}>
